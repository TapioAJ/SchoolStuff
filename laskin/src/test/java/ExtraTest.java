...
public class ExtraTest extends AbstractParent {
    ...
    public static void testVirtaON() {
        System.out.println("Virta ON (ennen ensimmäistä testiä)");
        laskin.virtaON();
    }

    @AfterAll
    public static void testVirtaOFF() {
        System.out.println("Virta OFF (kaikki testit ajettu).");
        laskin.virtaOFF();
        laskin = null;
    }
    ...
    public void testNeliojuuri2() {
        laskin.neliojuuri(2);
        assertEquals(1.414, laskin.annaTulos(), DELTA,"Luvun 2 neliöjuuri väärin");
    }
    
    @Test
    @DisplayName("Testaa negatiivinen neliöjuuri")
    public void testNeliojuuriNegat() {
        assertThrows(ArithmeticException.class, () -> laskin.neliojuuri(-2));
    }
}
